...
public class ProUtility3 {
	...
	public Set<Integer> victrans = null;
	public ProUtility3(List<TransactionTP> Database, List<Itemset> Itemsets, List<Integer> senList, int minutil, Map<Integer,Integer> ExUtility){
	...
	public List<TransactionTP>  runAlgorithm(){
	    ...
	    System.out.println("SMIU�㷨����ʱ��"+(endTimestamp-startTimestamp));
	...
	public void Updata(int victimTran,ItemUtility victimItem,int senID){
		...
		TransactionTP transaction = database.get(victimTran-1);
		//System.out.println(victimTran+" "+victimItem.item+"Ч��ֵ�� "+victimItem.utility+"�������ID: "+senID);
