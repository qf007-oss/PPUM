...
public class MaxUtility {
	...
	static double sensitiveThreshold; // ���ڿ�����Ҫ��������ĸ���
	public MaxUtility(int min_utility,int minPeriodicity,int maxPeriodicity,
	...
	public void test(List<Integer> senIDs, String filename) throws IOException{
		...
		// ԭʼ���ݼ���ֱ������PHM
		//String inputBeforeDBPHM = fileToPath("syntheticData.txt");
		String inputBeforeDBPHM = before+"item_PHM/"+filename+".txt";
		// ԭʼ���ݼ��ھ�������ڸ�Ч���
		//String outputBeforePHUI = "tempPHUI_file/contextPHM.txt";
		...
		int DBUtility_old = readDB.getDU();
		List<Integer> senIDsCopy = new ArrayList<>();
		senIDsCopy.addAll(senIDs);

		DatabaseProcess DBprocess = new DatabaseProcess();
		DBprocess.genLink(Database, itemsets, senIDs);//�������ݿ���Ŀ����

		List<Itemset> itemsetsCopy=DataCopy.ItemsetsCopy(itemsets);
        ProUtility1 protect = new ProUtility1(Database,itemsets,senIDsCopy,min_utility,Ex_Utility);
