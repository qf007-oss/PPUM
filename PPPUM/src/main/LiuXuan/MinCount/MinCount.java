...
public class MinCount {
	...
	public MinCount(int min_utility,int minPeriodicity,int maxPeriodicity,
	...
	public void test(List<Integer> senIDs,String filename) throws IOException{
        ...
        ProUtility2 protect = new ProUtility2(Database,itemsets,senIDsCopy,min_utility,Ex_Utility);
