...
public class MainTestPHM {
	...
	public static void main(String [] arg) throws IOException{
		...
		String output = "tempPHUI_file/contextPHM.txt";
		...
		String input = fileToPath("syntheticData.txt"); //4s
		//String input = fileToPath("ecommerce.txt"); //4s
		//String input = fileToPath("mushroom.txt"); // 1000, 1-6000-5-2000, 3855s
		//String input = fileToPath("synthetic_data.txt");
		//String input = fileToPath("BMS.txt"); //0.8s

		//String input = fileToPath("chess.txt");
		int min_utility = 260; // 180000
		int minPeriodicity = 1;  // minimum periodicity parameter (a number of transactions)
		int maxPeriodicity = 6;  // maximum periodicity parameter (a number of transactions)
