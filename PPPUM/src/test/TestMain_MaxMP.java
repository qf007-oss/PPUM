...
public class TestMain_MaxMP {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        int min_utility = 1000000; // 180000
        ...
        double sensitiveThreshold = 0.01; // 用于控制需要的敏感项集的个数
        ...
        pppum.readSensitiveHUI(outputBeforeSPHUI); // 初步构建敏感项集列表
        pppum.readDatabaseFile(inputBeforeDB); // 构建敏感项集列表
